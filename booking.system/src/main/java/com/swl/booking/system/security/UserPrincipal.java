...
public class UserPrincipal implements UserDetails {
	...
	public UserPrincipal(Long id, String phno, String password, String orgNo, boolean isSuperAdmin, Collection<? extends GrantedAuthority> authorities) {
		this.id = id;
		this.phno = phno;
...
//			}
		...
		return new UserPrincipal(user.getId(), user.getPhno(), user.getPassword(), user.getCountry(), user.isVerified(), authorities);
	}
