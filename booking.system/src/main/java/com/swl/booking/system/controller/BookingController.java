...
public class BookingController {
	...
	@PostMapping("/checkInClass")
	public ApiResponse<String> checkInClass(@Valid @RequestBody ApiRequest<CheckInClassRequest> apiRequest) {
		CheckInClassRequest req = apiRequest.getData();
		bookingService.checkInClass(req);
		return new ApiResponse<>(CommonConstant.MSG_PREFIX_SUCCESS, "Check in class is successful.");
	}
}
